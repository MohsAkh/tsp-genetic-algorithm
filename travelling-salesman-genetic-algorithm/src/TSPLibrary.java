...
public class TSPLibrary {
	public static ArrayList<Point2D> loadTSPLib(String fname){
		...
		// weight type is EUC_2D
		// It will work for examples such as rl5915.tsp. Other files
		// such as fri26.tsp use a different format, you will have to
		// modifPoint2Dcode
		...
		try {
			String currentLine;
			int dimension = 0; //Hold dimension of the problem
			...
			while ((currentLine = br.readLine()) != null){
				...
				if(currentLine.contains("DIMENSION")){
					//Note the expected problem dimension (number
					// of cities)
					String[] tokens = currentLine.split(":");
